...
class GetItemId(IntEnum):
    ...
    GI_SOUL_OCTOROK = 0x2001
    GI_SOUL_WALLMASTER = 0x2002
    GI_SOUL_DODONGO = 0x2003
    GI_SOUL_KEESE = 0x2004
    GI_SOUL_TEKTITE = 0x2005
    GI_SOUL_PEAHAT = 0x2006
    GI_SOUL_LIZALFOS_AND_DINALFOS = 0x2007
    GI_SOUL_GOHMA_LARVAE = 0x2008
    GI_SOUL_SHABOM = 0x2009
    GI_SOUL_BABY_DODONGO = 0x200A
    GI_SOUL_BIRI_AND_BARI = 0x200B
    GI_SOUL_TAILPASARAN = 0x200C
    GI_SOUL_SKULLTULA = 0x200D
    GI_SOUL_TORCH_SLUG = 0x200E
    GI_SOUL_MOBLIN = 0x200F
    GI_SOUL_ARMOS = 0x2010
    GI_SOUL_DEKU_BABA = 0x2011
    GI_SOUL_DEKU_SCRUB = 0x2012
    GI_SOUL_BUBBLE = 0x2013
    GI_SOUL_BEAMOS = 0x2014
    GI_SOUL_FLOORMASTER = 0x2015
    GI_SOUL_REDEAD_AND_GIBDO = 0x2016
    GI_SOUL_SKULLWALLTULA = 0x2017
    GI_SOUL_FLARE_DANCER = 0x2018
    GI_SOUL_DEAD_HAND = 0x2019
    GI_SOUL_SHELL_BLADE = 0x201A
    GI_SOUL_LIKE_LIKE = 0x201B
    GI_SOUL_SPIKE_ENEMY = 0x201C
    GI_SOUL_ANUBIS = 0x201D
    GI_SOUL_IRON_KNUCKLE = 0x201E
    GI_SOUL_SKULL_KID = 0x201F
    GI_SOUL_FLYING_POT = 0x2020
    GI_SOUL_FREEZARD = 0x2021
    GI_SOUL_STINGER = 0x2022
    GI_SOUL_WOLFOS = 0x2023
    GI_SOUL_GUAY = 0x2024
    GI_SOUL_QUEEN_GOHMA = 0x2025
    GI_SOUL_KING_DODONGO = 0x2026
    GI_SOUL_BARINADE = 0x2027
    GI_SOUL_PHANTOM_GANON = 0x2028
    GI_SOUL_VOLVAGIA = 0x2029
    GI_SOUL_MORPHA = 0x202A
    GI_SOUL_BONGO_BONGO = 0x202B
    GI_SOUL_TWINROVA = 0x202C
    GI_SOUL_JABU_JABU_TENTACLE = 0x202D
    GI_SOUL_DARK_LINK = 0x202E
    GI_SOUL_REGIONAL_DEKU_TREE = 0x202F
    GI_SOUL_REGIONAL_DODONGOS_CAVERN = 0x2030
    GI_SOUL_REGIONAL_JABU = 0x2031
    GI_SOUL_REGIONAL_FOREST_TEMPLE = 0x2032
    GI_SOUL_REGIONAL_FIRE_TEMPLE = 0x2033
    GI_SOUL_REGIONAL_WATER_TEMPLE = 0x2034
    GI_SOUL_REGIONAL_SHADOW_TEMPLE = 0x2035
    GI_SOUL_REGIONAL_SPIRIT_TEMPLE = 0x2036
    GI_SOUL_REGIONAL_BOTW = 0x2037
    GI_SOUL_REGIONAL_ICE_CAVERN = 0x2038
    GI_SOUL_REGIONAL_GTG = 0x2039
    GI_SOUL_REGIONAL_GANONS_CASTLE = 0x203A
    GI_SOUL_REGIONAL_FOREST_AREA = 0x203B
    GI_SOUL_REGIONAL_HYRULE_FIELD = 0x203C
    GI_SOUL_REGIONAL_LAKE_HYLIA = 0x203D
    GI_SOUL_REGIONAL_GERUDO_AREA = 0x203E
    GI_SOUL_REGIONAL_MARKET_AREA = 0x203F
    GI_SOUL_REGIONAL_KAKARIKO_AREA = 0x2040
    GI_SOUL_REGIONAL_GORON_AREA = 0x2041
    GI_SOUL_REGIONAL_ZORA_AREA = 0x2042
    GI_SOUL_REGIONAL_LLR = 0x2043
    GI_SOUL_REGIONAL_GROTTOS = 0x2044
    GI_FISHING_ROD = 0x2100
    GI_FISH_CHILD_6LB = 0x2101
    GI_FISH_CHILD_8LB = 0x2102
    GI_FISH_CHILD_10LB = 0x2103
    GI_FISH_ADULT_10LB = 0x2104
    GI_FISH_ADULT_12LB = 0x2105
    GI_FISH_ADULT_16LB = 0x2106
    GI_FISH_LOACH = 0x2107
